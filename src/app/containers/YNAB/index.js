...
// import { Form, Input, DatePicker, Col, TimePicker, Select, Cascader, InputNumber, Menu, Button, Icon, message } from 'antd';
...
class YNAB extends Component {
	...
	render() {
		console.log('props at ynab', this.props);
		// 	const data2 = []
		// 	const menu = (
		// 		<Select
...
const mapStateToProps = state => ({ ynab: state.ynab });

export default connect(mapStateToProps)(YNAB);

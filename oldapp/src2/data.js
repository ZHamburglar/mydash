const emails = {
    ...
    '5': {
        id: '5',
        title: 'Added Bonus Email',
        message:
            'This is an added bonus email I made to play around with data. I have just started playing with it. It does make sense to use a flux-like implementation, to provide a layer between the router and view updates.'
    },
    '3': {
        id: '3',
